  ...
  const publicationsData: Publication[] = [
    {
      ...
      description: 'Collaborative learning in virtual environments presents unique challenges. In this article we',
      image: firstImage1,
      date: 'Apr 15, 2023',
      category: {
        name: 'Pedagogy',
    ...
    },
    {
      ...
      description: 'Discover how to use digital tools to conduct effective formative assessments that provide',
      image: firstImage2,
      date: 'May 3, 2023',
      category: {
    ...
    },
    {
      ...
      description: 'Emotional intelligence is as important as academic skills. Learn how to effectively integrate',
      image: firstImage3,
      date: 'May 20, 2023',
      category: {
    ...
    },
    {
      ...
      description: 'A step-by-step guide to implementing project-based learning in your classroom, with',
      image: firstImage2,
      date: 'Jun 8, 2023',
      category: {
    ...
    },
    {
      ...
      description: 'Universal Design for Learning offers a framework for creating educational environments',
      image: firstImage6,
      date: 'Jul 2, 2023',
      category: {
