              ...
              <div className="space-y-3">
                <div className="bg-gray-100 dark:bg-[#1F2937] rounded-lg p-3">
                  <div className="flex justify-between items-start mb-1">
                    <span className="text-xs bg-teal-100 dark:bg-teal-500/20 text-teal-600 dark:text-teal-500 px-2 py-0.5 rounded">
                      Article
                    </span>
              ...
              <div className="space-y-3">
                <div className="bg-gray-100 dark:bg-[#1F2937] rounded-lg p-3">
                  ...
                  <div className="flex justify-between mt-1">
                    <span className="text-xs bg-emerald-100 dark:bg-emerald-500/20 text-emerald-600 dark:text-emerald-400 px-2 py-0.5 rounded">
                      Technology
                    </span>
                ...
                <div className="bg-gray-100 dark:bg-[#1F2937] rounded-lg p-3">
                  ...
                  <div className="flex justify-between mt-1">
                    <span className="text-xs bg-purple-100 dark:bg-purple-500/20 text-purple-600 dark:text-purple-400 px-2 py-0.5 rounded">
                      Programming
                    </span>
                    <div className="flex items-center gap-3 text-xs text-gray-600 dark:text-gray-400">
                      <span>124</span>
                ...
                <div className="bg-gray-100 dark:bg-[#1F2937] rounded-lg p-3">
                  <h4 className="text-sm font-medium text-gray-900 dark:text-gray-200">
                    Neuroscience-based Study Techniques
                  </h4>
                  <div className="flex justify-between mt-1">
                    <span className="text-xs bg-blue-100 dark:bg-blue-500/20 text-blue-600 dark:text-blue-400 px-2 py-0.5 rounded">
                      Education
