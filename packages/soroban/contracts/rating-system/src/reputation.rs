...
use crate::constants::{
    DELIVERY_WEIGHT, COMMUNICATION_WEIGHT, ACCURACY_WEIGHT, VALUE_WEIGHT,
    HIGH_REPUTATION_THRESHOLD, MEDIUM_REPUTATION_THRESHOLD
};
...
pub fn update_reputation(
    ...
    reputation_data.reputation_score = calculate_reputation_score(
        reputation_data.total_score,
        reputation_data.rating_count,
    );
...
pub fn calculate_reputation_score(total_score: u32, rating_count: u32) -> u32 {
    ...
    let max_score_per_rating = 5 * (DELIVERY_WEIGHT + COMMUNICATION_WEIGHT + ACCURACY_WEIGHT + VALUE_WEIGHT);
