...
fn test_tier_level_from_contribution() {
    ...
    assert_eq!(TierLevel::from_contribution(xlm_to_stroops(50)), TierLevel::None);
    assert_eq!(TierLevel::from_contribution(xlm_to_stroops(100)), TierLevel::Basic);
    assert_eq!(TierLevel::from_contribution(xlm_to_stroops(499)), TierLevel::Basic);
    assert_eq!(TierLevel::from_contribution(xlm_to_stroops(500)), TierLevel::Pro);
    assert_eq!(TierLevel::from_contribution(xlm_to_stroops(1999)), TierLevel::Pro);
    assert_eq!(TierLevel::from_contribution(xlm_to_stroops(2000)), TierLevel::Elite);
    assert_eq!(TierLevel::from_contribution(xlm_to_stroops(10000)), TierLevel::Elite);
}
